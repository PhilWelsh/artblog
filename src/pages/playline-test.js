    ...
    import LoadingBar from "./playlineComponents/LoadingBar"
    import Container from "./playlineComponents/Container"
    import Footer from "./playlineComponents/Footer"

const PlaylinePage = () => {
    const dataEndPoint = "https://playline-dev-test.s3-us-west-2.amazonaws.com/playline-test.json";
    const errorEndPoint = "https://wrongURL.json" //for testing    
