...
//     let allLetters = splitWord.map((letter, i ) => { // for each letter in the word
//         if (!lettersRemaining.includes(letter)){
//             return <div id={i} key={i} className="letterholder">{letter}</div>} else
//             {return <div id={i} key={i} className="letterholder">_</div>}
//         }
//     )
//     return (
