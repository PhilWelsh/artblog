...
const PlayWindow = () => {
  ...
  const renderPlayerRoster = playerRoster.players.map((player, i) => {return(
    <div key={i} className="player to-upper">
      <img alt={`${player.last_name} face`} src={`/static/assets/headshots/${player.last_name}.png`}/>
  ...
  return (
    <nav className="play-window">
      ...
      <div className="action-buttons">
        <a id="notify" className="button" href="https://app.playline.com/"><img src="/static/assets/icons/notify-me.svg" srcSet="/static/assets/icons/notify-me@2x.png 2x, /static/assets/icons/notify-me@3x.png 3x" alt="bell" /><span>Notify Me</span></a>
        <a id="deposit" className="button" href="https://app.playline.com/"><img src="/static/assets/icons/money-bag.svg" srcSet="/assets/icons/money-bag@2x.png 2x, /static/assets/icons/money-bag@3x.png 3x" alt="money" /><span>Deposit</span></a>
      </div>
      <hr style={{opacity:0.1}}/>
      <div className="app-download">
      <div className="message to-upper"><p>Download the App</p></div>
      <div id="download-buttons">
        <a className="app-button" href="https://play.google.com/store/"><img src="/static/assets/icons/ios-app.svg" srcSet="/static/assets/icons/ios-app@2x.png 2x, /static/assets/icons/ios-app@3x.png 3x" alt="ios app" /></a>
        <a className="app-button" href="https://www.apple.com/ca/app-store/"><img src="/static/assets/icons/google-play.svg" srcSet="/static/assets/icons/google-play@2x.png 2x, /static/assets/icons/google-play@3x.png 3x" alt="google play" /></a>
        </div>
      </div>
    </nav>
  );
